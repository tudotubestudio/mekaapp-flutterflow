                ...
                child: Row(
                  ...
                  children: [
                    FFButtonWidget(
                      onPressed: () async {
                        logFirebaseEvent(
                            'CLIENTS_ADMIN_NO_PAY_EN_COURS_BTN_ON_TAP');
                    ...
                    FFButtonWidget(
                      onPressed: () async {
                        logFirebaseEvent(
                            'CLIENTS_ADMIN_NO_PAY_TODAY_BTN_ON_TAP');
                        logFirebaseEvent('Button_navigate_to');
                    ...
                    FFButtonWidget(
                      onPressed: () async {
                        logFirebaseEvent(
                            'CLIENTS_ADMIN_NO_PAY_NO_PAY_BTN_ON_TAP');
                        logFirebaseEvent('Button_navigate_to');
                          ...
                          itemBuilder: (context, _, taskIndex) {
                            ...
                            return Padding(
                              ...
                              child: InkWell(
                                onTap: () async {
                                  logFirebaseEvent(
                                      'CLIENTS_ADMIN_NO_PAY_transaction_ON_TAP');
                                  if ((functions

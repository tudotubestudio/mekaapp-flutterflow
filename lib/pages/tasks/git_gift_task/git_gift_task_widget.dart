...
import 'git_gift_task_model.dart';
export 'git_gift_task_model.dart';
...
class _GitGiftTaskWidgetState extends State<GitGiftTaskWidget> {
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => GitGiftTaskModel());
                    ...
                    if (functions.jsonToInt(getJsonField(
                      ...
                      Padding(
                        ...
                        child: FFButtonWidget(
                          onPressed: () async {
                            logFirebaseEvent(
                                'GIT_GIFT_TASK_GET_CHIFFRE_BTN_ON_TAP');
                            ...
                            if ((_model.rGetChiffreQuota?.succeeded ?? true)) {
                              ...
                              ScaffoldMessenger.of(context).showSnackBar(
                                SnackBar(
                                  content: Text(
                                    getJsonField(
                                      (_model.rGetChiffreQuota?.jsonBody ?? ''),
                                      r'''$.seccess''',
                                    ).toString(),
                            ...
                            if ((_model.rGetChiffreQuotaPerc?.succeeded ??
                              ...
                              ScaffoldMessenger.of(context).showSnackBar(
                                SnackBar(
                                  content: Text(
                                    getJsonField(
                                      (_model.rGetChiffreQuotaPerc?.jsonBody ??
                                          ''),
                                      r'''$.seccess''',
                                    ).toString(),
                                    style: GoogleFonts.getFont(
                            ...
                            if (functions.jsonToInt(getJsonField(
                              ...
                              Padding(
                                ...
                                child: FFButtonWidget(
                                  onPressed: () async {
                                    logFirebaseEvent(
                                        'GIT_GIFT_TASK_GET_PRODUCTS_BTN_ON_TAP');
                                    logFirebaseEvent('Button_backend_call');
                                    ...
                                    if ((_model.rGetProdsQuota?.succeeded ??
                                        true)) {
                                      logFirebaseEvent('Button_show_snack_bar');

...
class _MainCopyWidgetState extends State<MainCopyWidget> {
  ...
  void initState() {
    ...
    logFirebaseEvent('screen_view', parameters: {'screen_name': 'MainCopy'});
    // On page load action.
    SchedulerBinding.instance.addPostFrameCallback((_) async {
      logFirebaseEvent('MAIN_COPY_PAGE_MainCopy_ON_INIT_STATE');
      logFirebaseEvent('MainCopy_backend_call');
      _model.apiResultu97 = await AuthGroup.meCall.call(
        token: valueOrDefault(currentUserDocument?.token, ''),
      );
      if ((_model.apiResultu97?.succeeded ?? true)) {
        logFirebaseEvent('MainCopy_update_app_state');
        FFAppState().update(() {
          FFAppState().me = (_model.apiResultu97?.jsonBody ?? '');
        });
      } else {
        logFirebaseEvent('MainCopy_show_snack_bar');
    ...
    return GestureDetector(
      ...
      child: Scaffold(
            ...
            children: [
              ...
              Padding(
                ...
                child: FFButtonWidget(
                  onPressed: () async {
                    logFirebaseEvent('MAIN_COPY_PAGE_LOG_IN_BTN_ON_TAP');
              ...
              Padding(
                ...
                child: FFButtonWidget(
                  onPressed: () async {
                    logFirebaseEvent('MAIN_COPY_PAGE_LOG_OUT_BTN_ON_TAP');
                ...
                Padding(
                  ...
                  child: AuthUserStreamWidget(
                    builder: (context) => FFButtonWidget(
                      onPressed: () async {
                        logFirebaseEvent('MAIN_COPY_PAGE_ADD_TASK_BTN_ON_TAP');
                        logFirebaseEvent('Button_navigate_to');
                ...
                Padding(
                  ...
                  child: AuthUserStreamWidget(
                    builder: (context) => FFButtonWidget(
                      onPressed: () async {
                        logFirebaseEvent(
                            'MAIN_COPY_PAGE_ORDRE_MISSION_BTN_ON_TAP');
                        logFirebaseEvent('Button_navigate_to');
        ...
        appBar: AppBar(
          ...
          leading: InkWell(
            onTap: () async {
              logFirebaseEvent('MAIN_COPY_PAGE_Icon_yaxwkyuf_ON_TAP');
            ...
            child: Column(
              ...
              children: [
                Padding(
                  ...
                  child: FFButtonWidget(
                    onPressed: () async {
                      logFirebaseEvent('MAIN_COPY_PAGE_STORE_BTN_ON_TAP');
                      logFirebaseEvent('Button_navigate_to');
                ...
                Padding(
                  ...
                  child: FFButtonWidget(
                    onPressed: () async {
                      logFirebaseEvent('MAIN_COPY_PAGE_COMPIERE_BTN_ON_TAP');
                ...
                Padding(
                  ...
                  child: FFButtonWidget(
                    onPressed: () async {
                      logFirebaseEvent('MAIN_COPY_PAGE_NEW_TASKS_BTN_ON_TAP');
                      logFirebaseEvent('Button_navigate_to');
                ...
                Padding(
                  ...
                  child: FFButtonWidget(
                    onPressed: () async {
                      logFirebaseEvent('MAIN_COPY_PAGE_TASKS_ADMIN_BTN_ON_TAP');
                      logFirebaseEvent('Button_navigate_to');
                ...
                FFButtonWidget(
                  onPressed: () async {
                    logFirebaseEvent('MAIN_COPY_PAGE_BUTTON_BTN_ON_TAP');

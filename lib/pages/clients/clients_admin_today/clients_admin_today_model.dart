...
class ClientsAdminTodayModel extends FlutterFlowModel {
  ...
  PagingController<ApiPagingParams, dynamic> _createListViewController(
    ...
    return controller..addPageRequestListener(listViewTasksNoValidTodayPage);
  }

  void listViewTasksNoValidTodayPage(ApiPagingParams nextPageMarker) =>
      listViewApiCall!(nextPageMarker)
          .then((listViewTasksNoValidTodayResponse) {
        final pageItems = (ClientsGroup.tasksNoValidTodayCall.data(
                  listViewTasksNoValidTodayResponse.jsonBody,
                )! ??
                [])
            .toList() as List;
        ...
        listViewPagingController?.appendPage(
          ...
          (pageItems.length > 0)
              ? ApiPagingParams(
                  ...
                  lastResponse: listViewTasksNoValidTodayResponse,
                )
              : null,
        );
      });

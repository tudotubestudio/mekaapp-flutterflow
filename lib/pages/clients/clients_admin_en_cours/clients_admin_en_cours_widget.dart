...
import 'clients_admin_en_cours_model.dart';
export 'clients_admin_en_cours_model.dart';

class ClientsAdminEnCoursWidget extends StatefulWidget {
  const ClientsAdminEnCoursWidget({Key? key}) : super(key: key);

  @override
  _ClientsAdminEnCoursWidgetState createState() =>
      _ClientsAdminEnCoursWidgetState();
}

class _ClientsAdminEnCoursWidgetState extends State<ClientsAdminEnCoursWidget> {
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ClientsAdminEnCoursModel());

    logFirebaseEvent('screen_view',
        parameters: {'screen_name': 'ClientsAdminEnCours'});
      ...
      child: Scaffold(
        ...
        appBar: AppBar(
          ...
          leading: FlutterFlowIconButton(
            ...
            onPressed: () async {
              logFirebaseEvent('CLIENTS_ADMIN_EN_COURS_arrow_back_rounde');

                ...
                child: Row(
                  ...
                  children: [
                    FFButtonWidget(
                      onPressed: () async {
                        logFirebaseEvent(
                            'CLIENTS_ADMIN_PAGE_EN_COURS_BTN_ON_TAP');
                    ...
                    FFButtonWidget(
                      onPressed: () async {
                        logFirebaseEvent('CLIENTS_ADMIN_PAGE_TODAY_BTN_ON_TAP');
                        logFirebaseEvent('Button_navigate_to');
                    ...
                    FFButtonWidget(
                      onPressed: () async {
                        logFirebaseEvent(
                            'CLIENTS_ADMIN_PAGE_NO_PAY_BTN_ON_TAP');
                        logFirebaseEvent('Button_navigate_to');
                ...
                child: Padding(
                  ...
                  child: AuthUserStreamWidget(
                    builder: (context) => RefreshIndicator(
                      onRefresh: () async {
                        logFirebaseEvent(
                            'CLIENTS_ADMIN_ListView_ny5ks9iq_ON_PULL_');
                          ...
                          itemBuilder: (context, _, taskIndex) {
                            ...
                            return Padding(
                              ...
                              child: InkWell(
                                onTap: () async {
                                  logFirebaseEvent(
                                      'CLIENTS_ADMIN_PAGE_transaction_ON_TAP');
                                  if ((functions
